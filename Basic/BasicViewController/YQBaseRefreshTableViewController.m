...
- (void)viewDidLoad {
    ...
    CGFloat y = [DeviceHelper isiPadOnMac] ? 20 : 0;
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, PUB_NAVBAR_HEIGHT + y, self.view.frame.size.width, self.view.frame.size.height - PUB_NAVBAR_HEIGHT) style:self.style];
