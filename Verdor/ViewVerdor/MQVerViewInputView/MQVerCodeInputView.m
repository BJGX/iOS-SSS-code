...
@interface MQVerCodeInputView ()<UITextFieldDelegate>
...
-(void)mq_verCodeViewWithMaxLenght{
    ...
    for (int i=0; i<self.maxLenght; i++) {
        ...
        subView.backgroundColor = normalBackgroundColor;
...
- (void)changeViewLayerIndex:(NSInteger)index pointHidden:(BOOL)hidden{
    ...
    view.backgroundColor = hidden ? normalBackgroundColor : [UIColor whiteColor];
