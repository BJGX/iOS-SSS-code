...
#define ScreenWidth [DeviceHelper returnScreenWidth]
#define ScreenHeight  [DeviceHelper returnScreenHeight]



#define BOOK_WIDTH (ScreenWidth - 80) / 3.0

#define BOOK_Height BOOK_WIDTH *  134.0 / 98.0
...
#define PUB_NAVBAR_HEIGHT (statusRectH>20?88.0f:64.0f)

#define PUB_NAVBAR_OFFSET (statusRectH>20? 24.0f:0.0f)

#define PUB_TABBAR_HEIGHT (statusRectH>20?83.0f:50.0f)

#define PUB_TABBAR_OFFSET (statusRectH>20?34.0f:0.0f)
...
//  状态栏高度
#define kStatusBarHeight (statusRectH > 0 ? statusRectH : (is_iPhoneX ? 44.0 : 20.0))
...
// 普通cell高度
#define BOOK_NORMAL_CELL_HEIGHT (BOOK_HEIGHT + BOOK_CELL_TITLE_HEIGHT + kHalfMargin + kQuarterMargin)

// 混合cell高度
#define BOOK_MAX_CELL_HEIGHT ((BOOK_HEIGHT - 10) + kMargin)
...
#define kMainTitleFont kBoldFont22

// 字号偏移量

#define kFontOffset (is_KiPhoneX_Max?2.0f:1.0f)
