...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
    ...
    if ([view.superview isMemberOfClass:NSClassFromString(@"YQBookDownloadManagementTableViewCell")] || [view.superview isMemberOfClass:NSClassFromString(@"YQComicDownloadManagementTableViewCell")] || [view.superview isMemberOfClass:NSClassFromString(@"YQHistoryTableViewCell")]){
