...
//MARK: -  指示器样式为SGIndicatorStyleNewFixed 需要设置一下参数
///固定image
@property (nonatomic, strong) UIImage *indicatorFixedImage;
...
/** 选中状态下标题文字的背景颜色 */
@property (nonatomic, strong) UIColor *titleSelectedBackgroundColor;
