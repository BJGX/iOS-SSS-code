...
- (void)pageTitleView:(SGPageTitleView *)pageTitleView setButtonState:(UIButton *)sender index:(NSInteger)selectedIndex;
...
///修改按钮状态
- (void)yq_changeSelectedStateButton:(NSInteger)index;
