...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:[NSNumber numberWithUnsignedInteger:[self fileIndex]] forKey:@"fileIndex"];
...
- (nullable instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self != nil) {
        ...
        [self setFileIndex:[[aDecoder decodeObjectForKey:@"fileIndex"] integerValue]];
    }
